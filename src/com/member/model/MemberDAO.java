...
public class MemberDAO implements MemberDAO_interface {
	...
	private static final String GET_ALL_STMT_BY_MEMLOGINNUM = 
			"SELECT * FROM member order by memLoginNum Desc";
...
//		List<String> base64list = new ArrayList<String>();//base64浣滄硶
...
//			}
	...
	public List<MemberVO> getAllByHot() {
		...
		try {
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(GET_ALL_STMT_BY_MEMLOGINNUM);
			rs = pstmt.executeQuery();
