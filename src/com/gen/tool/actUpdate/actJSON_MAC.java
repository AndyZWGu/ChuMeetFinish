...
//										System.out.println("path=" + path);
										...
										if (!actg.getImageUrl().trim().equals("")) {
											...
											if (end > start) {
												...
												//MAC用路徑/Users/zhongwei/CloudStation/DB_BLOB_CLOB/POIBLOB
												String path2 = "/Users/zhongwei/CloudStation/DB_BLOB_CLOB/POIBLOB" + actg.getCategory() + ".jpg";
...
//										System.out.println("mu=" + mu);
									...
									q++;
								} // end of if		//鎴愬姛閫插叆鍒ゆ柗+DB
								j++;						//鏈夐�茶看鍦堢殑绺芥暩
							} catch (Exception e) {
								j++;						//鏈塭xception鎴戜篃瑕乶ext
								continue;
							}
						} // end of while
