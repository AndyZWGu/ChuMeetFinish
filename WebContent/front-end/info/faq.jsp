...
List <FAQVO> faqList = (List<FAQVO>)faqSvc.getAll();
for(FAQVO list : faqList){
...
<c:forEach items="${faqList}" var="faqList">
                               ...
                               <div class="panel-heading">
                                  <h4 class="panel-title">
                                     <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#${faqList.FAQID}">
                                     ${faqList.FAQID}. ${faqList.FAQTitle}
                                     </a>
                                  </h4>
                               </div>
                               <div id="${faqList.FAQID}" class="panel-collapse collapse">
