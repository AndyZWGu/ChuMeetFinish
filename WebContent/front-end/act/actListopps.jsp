							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-3">
									<ul class="tabbable actl-tabbable">
										...
										if(!pageName.equals("getMyAct2")){ %> collapse<%} %>" id="myAct">
											<li <%if(pageName.equals("getMyAct2")){%> class="active" <%} %>><a
												href="<%=request.getContextPath()%>/front-end/act/act.do?action=getMyAct2">參加中</a></li>
											<li <%if(pageName.equals("getMyAct1")){%> class="active" <%} %>><a
												href="<%=request.getContextPath()%>/front-end/act/act.do?action=getMyAct1">我舉辦的活動</a></li>
											<li <%if(pageName.equals("getMyAct5")){%> class="active" <%} %>><a
												href="<%=request.getContextPath()%>/front-end/act/act.do?action=getMyAct5">追蹤中</a></li>
											<!-- 								<li><a href="#">邀請中</a></li> -->
											<!-- 								<li><a href="#">社團活動</a></li> -->
											<!-- 								<li><a href="#">好友活動</a></li> -->
										</ul>
